 ...
 * @author amkt922
 */
class CreateEntityMetaCommand extends AbstractCommand {

    const TEMPLATE_FILE = 'EntityMeta.php';
	...
	public function process() {
		...
		foreach ($tables as $table) {
            ...
            foreach ($columns as $index => $column) {
                $columns[$index]['constName'] = strtoupper($column['name']);
            }
            ...
            file_put_contents($outDir . $className . 'Meta.php', $def);
		}
	}
